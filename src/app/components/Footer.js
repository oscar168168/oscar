  ...
  return (
    <div className="py-4 lg:py-10 border-t bg-[#fafaff]">
        <div className="lg:mb-6">
          ...
          <p className="text-gray-600 text-sm lg:text-base font-light text-center my-2 lg:my-4">
            E: ratraksmey@gmail.com | T: +885 11 259 581
          </p>
        </div>
        <div>
          <p className="text-gray-800 font-medium text-sm lg:text-base test-underline justify-center items-center flex flex-row gap-6">
